...
const OWNER_NAME = "";
const NOMOR_BOT = "6287798551054"; // 628xx nomor wa
...
const SIMILARITY = false; // Pencarian kemiripan command (true, false)
...
const WEBSITE = "";
const DATA_OWNER = ["6283193200042"];
...
// antispam di grub
const SPAM_LIMIT = 4; // Batas pesan dianggap spam
const SPAM_COULDOWN = 60; // Waktu cooldown dalam detik (10 detik)
...
const config = {
  ...
  status_prefix: false, // wajib prefix : atau false tanpa prefix
  prefix: [".", "!", "#"],
